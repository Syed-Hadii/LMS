...
const fetchData = async () => {
  ...
  try {
    ...
    const filteredData = combinedData.filter(
      (item) => item.recieve_method === "Cash" || item.payment_method === "Cash"
    );
   ...
   const filterData = () => {
     const filtered = sortedData.filter((item) => {
       if (searchTerm === "Payment Vouchers") {
         return item.payment_method?.toLowerCase() === "cash"; // Adjust as needed
       } else if (searchTerm === "Receipt Vouchers") {
         return item.recieve_method?.toLowerCase() === "cash"; // Adjust as needed
       }
...
const toggleDateFilter = () => {
  ...
  return (
    <div className="p-6">
      <h1 className="text-xl mb-5 font-semibold text-left">Cash Details</h1>
        ...
        >
          ...
          >
            ...
            <div className="space-y-2 text-gray-700">
              ...
              {/* Conditional Rendering for Receive or Payment Method */}
              <p>
              ...
              {selectedVoucher.payment_method === "Cash" && (
                <p>
